...
VALUES  (1, '鋼鐵人馬斯克', '阿什利·萬斯', '馬斯克曾兩度被自己一手創立的公司踢出門，其中之一是啟動線上支付革命的PayPal，如今他已蛻變成為全球百大影響力人物、科技界的超級偶像。跟賈伯斯一樣，馬斯克被稱為「改變世界的科技狂人」，但他的夢想顯然更大、也更瘋狂。他的Tesla排名超越Google、蘋果，名列全球最聰明企業，關鍵技術更是好到其他汽車大廠都不能沒有它；SpaceX是史上第一家為國際太空站運輸物資的私人航太公司，卻一再以不可思議的低成本和尖端技術，挑戰極限，創造太空業奇蹟。', '/CD-Book-Store-System/view/src/image/book-1.png', '100', '200', 'blue'),
        (2, 'Dr. TOEIC', '金映權, 朴梓亨, 金起漢, 張重維, Jennifer Thaler', '地表最強的多益滿分教授來了！最熟悉多益趨勢和出題方向的Dr. TOEIC多益教授，最能掌握多益必考詞彙、句型的Dr. TOEIC多益教授，共同歸納絕對會考的2,800個多益單字！聯手打造最真實的5回模擬試題！獨家公開最完整的實戰滿分祕訣！多益教授來了，出題老師的臉就綠了！5天完勝全新制多益考試，考取「金色證書」變簡單了！', '/CD-Book-Store-System/view/src/image/book-2.png', '200', '20', 'red'),
        ...
        (4, '創業這條路', '麥克．葛伯', '不管你做什麼行業，記帳士、美容師、美髮師、程式設計師、醫師、編輯、美工、會計師、設計師、水電工、業務員……。某一天在某個不明原因的誘使下，或許和天氣、工作有關，或許和薪水有關，或許老闆瞥了你一眼讓你感到不爽，或許你覺得老闆不肯定你的付出……，原因不重要，但自那一刻開始，你萌起了創業念頭，創業的決心如影隨形，一心想擺脫現狀當老闆，改變自己的人生和命運！', '/CD-Book-Store-System/view/src/image/book-4.png', '1240', '232', 'blue'),
        (5, '豆漿娘娘駕到', '阿晧（漿爸）', '千呼萬喚，百萬漿絲引頸期待！豆漿娘娘第一本寫真書華麗登場！', '/CD-Book-Store-System/view/src/image/book-5.png', '16800', '600', 'red'),
