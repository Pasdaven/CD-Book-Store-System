...
const cardComponent = (product_name, author_name) => {
    return `
    <div class="shadow card p-4 my-4">
        <div class="d-flex">
            <div class="px-3"><img src="./getImage.jfif" alt="" width="165" height="237"></div>
            <div class="flex-fill d-flex flex-column">
                <div class="align-self-end"><i class="bi bi-heart-fill" style="color: #F0B0B0;"></i></div>
                <div class="flex-fill d-flex  align-items-center justify-content-end">
                    ...
                    <div class="align-self-end pt-5">
                        <button type="button" class="ms-5 ps-5 btn btn-view-info" style="width:225px;height:60px;">View info<i class="ms-5 bi bi-info-circle-fill"></i></button>
...
const displayFollowListInfo = (data) => {
    for (i = 0; i < data.length; i++) {
        $('#followList').append(cardComponent(data[i][0]['product_name'], "pascal"));
    }
}
