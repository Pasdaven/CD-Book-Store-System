...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/CD-Book-Store-System/view/src/style/browserHistory.css">
    ...
    <body>
        <div class="page">
            ...
            <div class="container py-5">
                <div class="row align-items-center justify-content-center pt-5 mt-4">
                    <div>
                        <h1 class="mx-auto" style="width: 400px;font-size:36px;"><i class="bi bi-clock-history me-3"></i>Browsing History</h1>
                    </div>
                </div>
        ...
        <script src="../src/script/browserHistory.js?2022052901"></script>
    </body>
