        ...
        <div class="page">
            ...
            <div class="container py-5">
                <div class="row align-items-center justify-content-center pt-5 mt-4">
                    <div>
                        <h1 class="mx-auto" style="width: 300px;font-size:36px;"><i class="me-3 bi bi-search"></i>searchProduct</h1>
                    </div>
                </div>
                <div class="row my-3 justify-content-center">
                    <div class="col-12 scroll" style="width: 1053px;height:70vh;" id="searchProduct">
